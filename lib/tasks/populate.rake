namespace :populate do
  ...
  task create_nodes: :environment do
    ...
    gq1 = Node.create(nickname: "GQ 1", is_decision_point: false , branch_id: scenario_questions_branch.id, template_name: "gq-1", dashboard_type: "plane")
    ...
    ns4 = Node.create(nickname: "NS 4", is_decision_point: false , branch_id: scenario_questions_branch.id, template_name: "ns-4", dashboard_type: "car")
    ...
    ns5 = Node.create(nickname: "NS 5", is_decision_point: false , branch_id: scenario_questions_branch.id, template_name: "ns-5", dashboard_type: "car")
      ns5q = Question.create(node_id: ns5.id, question: "We're actually currently working on building this new location and want to make sure you find it as useful as possible. We want your input on how we should build this location.", question_type_id: single_choice.id)
        ns5qa1 = Answer.create(question_id: ns5q.id, answer: "NS 5 answer", icon_name: nil)

    # meet offsite at train ride
    # what is this?

    itf2 = Node.create(nickname: "ITF 2", is_decision_point: false , branch_id: meet_offsite_branch.id, template_name: "itf-2", dashboard_type: "car")
    ...
    # wait offsite
    c1 = Node.create(nickname: "C 1", is_decision_point: false , branch_id: wait_offsite_branch.id, template_name: "c-1", dashboard_type: "plane")
    ...
    c2 = Node.create(nickname: "C 2", is_decision_point: false , branch_id: wait_offsite_branch.id, template_name: "c-2", dashboard_type: "plane")
    ...
    c4 = Node.create(nickname: "C 4", is_decision_point: false , branch_id: wait_offsite_branch.id, template_name: "c-4", dashboard_type: "plane")
    ...
    # park and meet
    b1 = Node.create(nickname: "B 1", is_decision_point: false , branch_id: park_and_meet_branch.id, template_name: "b-1", dashboard_type: "plane")
    ...
    b2 = Node.create(nickname: "B 2", is_decision_point: false , branch_id: park_and_meet_branch.id, template_name: "b-2",  dashboard_type: "plane")
    ...
    b3 = Node.create(nickname: "B 3", is_decision_point: false , branch_id: park_and_meet_branch.id, template_name: "b-3", dashboard_type: "plane")
    ...
    b4 = Node.create(nickname: "B 4", is_decision_point: false , branch_id: park_and_meet_branch.id, template_name: "b-4", dashboard_type: "plane")
    ...
    # hope to catch
    a1 = Node.create(nickname: "A 1", is_decision_point: false , branch_id: hope_to_catch_curb_branch.id, template_name: "a-1", dashboard_type: "plane")
    ...
    a2 = Node.create(nickname: "A 2", is_decision_point: false , branch_id: hope_to_catch_curb_branch.id, template_name: "a-2", dashboard_type: "plane")
      a2q = Question.create(
        node_id: a2.id,
    ...
    e2 = Node.create(nickname: "E 2", is_decision_point: false , branch_id: ending_questions_branch.id, template_name: "e-2", dashboard_type: "car")
      e2q = Question.create(
        node_id: e2.id,
    ...
    e3 = Node.create(nickname: "E 3", is_decision_point: false , branch_id: ending_questions_branch.id, template_name: "e-3", dashboard_type: "car")
      e3q = Question.create(
        node_id: e3.id,
    ...
    e4 = Node.create(nickname: "E 4", is_decision_point: false , branch_id: ending_questions_branch.id, template_name: "e-4", dashboard_type: "car")
      e4q = Question.create(
        node_id: e4.id,
    ...
    e5 = Node.create(nickname: "E 5", is_decision_point: false , branch_id: ending_questions_branch.id, template_name: "e-5", dashboard_type: "car")
      e5q = Question.create(
        node_id: e5.id,
    ...
    e6 = Node.create(nickname: "E 6", is_decision_point: false , branch_id: ending_questions_branch.id, template_name: "e-6", dashboard_type: "car")
      e6q = Question.create(
        node_id: e6.id,
    ...
    # Decision Points
    noitf1 = Node.create(nickname: "No-ITF 1", is_decision_point: true , branch_id: meet_offsite_branch.id, template_name: "no-itf-1", dashboard_type: "car")
    ...
    dp1 = Node.create(nickname: "DP 1", is_decision_point: true , branch_id: scenario_questions_branch.id, template_name: "dp-1", dashboard_type: "plane")
    ...
    dp8 = Node.create(nickname: "DP 8", is_decision_point: true , branch_id: wait_offsite_branch.id, template_name: "dp-8", dashboard_type: "plane")
    ...
    dp7 = Node.create(nickname: "DP 7", is_decision_point: true , branch_id: wait_offsite_branch.id, template_name: "dp-7", dashboard_type: "plane")
    ...
    dp7a = Node.create(nickname: "DP 7a", is_decision_point: true , branch_id: wait_offsite_branch.id, template_name: "dp-7a", dashboard_type: "plane")
    ...
    dp11 = Node.create(nickname: "DP 11", is_decision_point: true , branch_id: park_and_meet_branch.id, template_name: "dp-11", dashboard_type: "plane")
    dp10 = Node.create(nickname: "DP 10", is_decision_point: true , branch_id: park_and_meet_branch.id, template_name: "dp-10", dashboard_type: "plane")
    dp6 = Node.create(nickname: "DP 6", is_decision_point: true , branch_id: park_and_meet_branch.id, template_name: "dp-6", dashboard_type: "plane")
    ...
    dp5 = Node.create(nickname: "DP 5", is_decision_point: true , branch_id: park_and_meet_branch.id, template_name: "dp-5", dashboard_type: "plane")
    ...
    dp2 = Node.create(nickname: "DP 2", is_decision_point: true , branch_id: hope_to_catch_curb_branch.id, template_name: "dp-2", dashboard_type: "plane")
